...
const AgencyDashboard = () => {
  ...
  const { data:profile } = useProfile({handle:"zzzzzz.test"});
            ...
            <div className="w-full Sm:w-7/12 bg-white self-start border-2 border-gray-500 rounded-xl overflow-hidden">
              <form className="w-full flex flex-col items-center mt-4" onSubmit={postToLens}>
                ...
                <div className="h-20 w-full flex items-center px-1 sm:px-4">
                  <Image height={50} width={50} src="" alt="" className="h-12 w-12 hidden sm:block rounded-[50%] bg-black" />
                  <div className="flex-1 flex items-center border-2 border-gray-500 h-8 sm:h-12 sm:ml-2 px-3 rounded-xl">
                    ...
                    <div className="mx-1 h-6 w-6">
                      <Image height={50} width={50} src="/assets/camera.svg" className="h-full w-full" alt="" />
                    </div>
                    <div className="mx-1 h-6 w-6">
                      <Image height={50} width={50} src="/assets/photo.svg" className="h-full w-full" alt="" />
                    </div>
                    <div className="mx-1 h-6 w-6">
                      <Image height={50} width={50} src="/assets/smiley.svg" className="h-full w-full" alt="" />
                    </div>
                  </div>
                </div>
